...
export function GithubIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M12 .5C5.65.5.5 5.65.5 12c0 5.08 3.29 9.39 7.86 10.91.58.11.79-.25.79-.55v-2.15c-3.2.7-3.87-1.36-3.87-1.36-.52-1.33-1.28-1.68-1.28-1.68-1.04-.71.08-.7.08-.7 1.15.08 1.76 1.19 1.76 1.19 1.03 1.76 2.7 1.25 3.35.96.1-.75.4-1.25.72-1.54-2.55-.29-5.23-1.28-5.23-5.69 0-1.26.45-2.29 1.19-3.09-.12-.29-.52-1.46.11-3.05 0 0 .97-.31 3.17 1.18a11.02 11.02 0 0 1 5.78 0c2.2-1.49 3.16-1.18 3.16-1.18.63 1.59.24 2.76.12 3.05.74.8 1.19 1.83 1.19 3.09 0 4.42-2.69 5.39-5.25 5.68.41.35.78 1.05.78 2.12v3.15c0 .3.2.66.8.55A11.51 11.51 0 0 0 23.5 12C23.5 5.65 18.35.5 12 .5Z" />
    </svg>
  );
}
...
export function ReactLogo(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#61DAFB" aria-hidden="true" {...props}>
...
export function ViteLogo(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#646CFF" aria-hidden="true" {...props}>
...
export function NitroLogo(props: IconProps) {
  return (
    <svg
      viewBox="0 0 32 32"
      fill="none"
      ...
      {...props}
    >
      <path d="M7 5v22M7 5l18 22M25 5v22" />
    </svg>
  );
}

export function HonoLogo(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#E36002" aria-hidden="true" {...props}>
...
export function PythonLogo(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#3776AB" aria-hidden="true" {...props}>
...
export function SparkleIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 2c.9 5.1 2.9 8 10 10-7.1 2-9.1 4.9-10 10-.9-5.1-2.9-8-10-10 7.1-2 9.1-4.9 10-10Z" />
    </svg>
  );
}
